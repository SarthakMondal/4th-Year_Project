...
<body>
    ...
    <div class="containerlogin" id="bkingbg">
        <div class="container-xxl" id="subdivone">
            <h2 id="subheading"><i class="fa fa-ambulance" aria-hidden="true"></i> My Active Booking </h2>
            ...
            <?php
                ...
                {
                    $dvr_id=$row1['user_id'];
                    $qry2 = "SELECT * FROM `user_info` WHERE `id` = $dvr_id";
            ...
            <div class="card ">
              <div class="card-body">
                <h5 class="card-text" style="line-height: 30px;">
                  <b>Patient Name:</b> <?php echo $dv_name; ?><br>
                  <b>Phone No:</b> <?php echo $ph_no; ?><br>
                  <b>Area:</b> <?php echo $area; ?><br>
                  <b>Address:</b> <?php echo $adres; ?><br>
             ...
             <a href="stedatn.php?id=<?php echo $id ?>"><button class="btn btn-primary btn-lg" id="btnjrny">Start/End Journy</button></a>
